      ...
      tenant: {
          ...
          handler(newVal) {
              if (newVal) {
                  ...
                  this.editTenantData.type = this.mapType(newVal.type);
                  this.editTenantData.state = this.mapState(newVal.state);
              }
          }
      }
  },
  methods: {
      ...
      openEdit() {
          if (this.tenant) {
              ...
              this.editTenantData.type = this.mapType(this.tenant.type);
              this.editTenantData.state = this.mapState(this.tenant.state);
